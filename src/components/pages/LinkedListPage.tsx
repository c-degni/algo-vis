...
import LinkedListVisualizer from '../visualizers/data_structures/LinkedListVisualizer';
...
export default function LinkedListPage() {
    ...
    const handleExecuteOperations = useCallback(async (operations: any[]) => {
        setIsExecuting(true);
        try {
            const response = await fetch('/api/data-structures/linkedlist/execute', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
                <h1 className="text-3xl font-bold text-gray-800 mb-4">Linked List Visualizer</h1>
                ...
                <p className="text-gray-600">
                    Build a sequence of linked list operations and watch them execute step by step.
                </p>
            </div>
