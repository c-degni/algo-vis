...
import BinaryTreeVisualizer from '../visualizers/data_structures/BinaryTreeVisualizer';
...
export default function BinaryTreePage() {
    ...
    const handleExecuteOperations = useCallback(async (operations: any[]) => {
        setIsExecuting(true);
        try {
            const response = await fetch('/api/data-structures/binarytree/execute', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
                <h1 className="text-3xl font-bold text-gray-800 mb-4">Binary Tree Visualizer</h1>
                ...
                <p className="text-gray-600">
                    Build a sequence of binary tree operations and watch them execute step by step.
                </p>
            </div>
